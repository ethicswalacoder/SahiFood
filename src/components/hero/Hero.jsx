...
const Hero = () => {
  ...
  return (
    <>
      <div
        style={bgImage}
        className="min-h-[550px] sm:min-h-[650px] bg-gray-100 dark:bg-gray-950 
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
              ...
              <p className="text-sm">
                Lorem ipsum dolor r adipisicing elit. Exercitationem minima
                dicta ducimus deleniti aliquid repellat, rem id provident
                excepturi molestiae ipsa in, voluptatibus laboriosam. Ab itaque
                officia commodi!
              </p>
              <div>
                <button
